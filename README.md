...
# Quick Start
See the PointCloud_Sample_Downloader_and_Visualizer.ipynb Jupyter Notebook for instructions on how to download samples from the dataset and visualize them using Python (Jupyter Notebook and Open3D)
